            ...
            <Grid divided>
              <Grid.Row>
                ...
                <Grid.Column width={10}>
                  <Progress color='teal' label={`${this.props.track.creator} - ${this.props.track.title}`} size='small' className='progress-bar' percent={this.state.progressPercent} />
                  <Container textAlign='center'>
					<Button.Group>
						<Button onClick={this.handlePrevious} icon='fast backward' />
						<Button onClick={this.handlePlayPause} icon={this.state.playIcon} />
